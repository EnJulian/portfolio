              ...
              const cardContent = (
                <>
                  <div className="flex justify-between items-start mb-2">
                    <h3 className="text-header-base font-medium text-white group-hover:text-gray-200 terminus-project flex items-center">
                      {project.title}
                  ...
                  <p className={`text-gray-400 text-[13.65px] mb-2 ${isExpanded ? '' : 'line-clamp-3'}`}>
                    {project.description}
                  </p>
